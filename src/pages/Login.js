...
export default function Login() {
    ...
    const {connectGoogle, isPending: Pending} = useSignup();
    ...
    return (
        <div className="flex flex-col justify-center items-center h-screen">
            <div className="w-[350px]">
                <h2 className="text-center text-5xl font-bold mb-8">Log In</h2>
                {/*Google Auth*/}
            ...
            <p className="text-center text-xs text-text-light mt-28 w-[500px]">By clicking “Continue with Google” or
                “Login with email” above, you acknowledge that you have read and
                understood, and agree to nothing.</p>
        </div>
    );
}